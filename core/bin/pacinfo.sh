...
multilib=$(grep multilib /home/onetwo/$dir/updates | wc -l)
...
^ro(119x20)^ib(2)^fg($BLUE)^pa(2)Onetwo!" > /home/onetwo/$dir/outputclick.txt

cat /home/onetwo/$dir/outputclick.txt | dzen2 -p -bg $BG -fg $YELLOW -y $Y -x $X -fn $FONT -l 5 -w 119 -ta l -e "onstart=uncollapse;button3=exit"
